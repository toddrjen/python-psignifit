...
def psignifit(data, optionsIn=None, **kwargs):
    ...
    if options['dynamicGrid'] and 'GridSetEval' not in options:
        options['GridSetEval'] = 10000
    if options['dynamicGrid'] and 'UniformWeight' not in options:
